package resultprocessing.utility;
...
import resultprocessing.export.pdf.ListToPDF;
import resultprocessing.main.MainController;



public class ResultProcessingUtil {
    ...
    public static void initPDFExprot(StackPane rootPane, Node contentPane, Stage stage, List<List> data,String sem) {
        ...
        boolean flag = ltp.doPrintToPdf(data, saveLoc, ListToPDF.Orientation.LANDSCAPE,sem);
        ...
        openBtn.setOnAction((ActionEvent event1) -> {
            try {
                ...
                AlertMaker.showError("Can't load file");
            }
        });
        if (flag) {
    ...
    public static void openFileWithDesktop(File file) {
        try {
            ...
            Logger.getLogger(ResultProcessingUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public static void initializeConfig(Object preferences,String file){
        Writer writer = null;
